...
@section('content')
    ...
    <div class="dashboard-cards">
        <div class="dashboard-card">
            <h3><i class="fas fa-server"></i> Server Aktif</h3>
        ...
        <div class="dashboard-card">
            <h3><i class="fas fa-network-wired"></i> Sistem Terhubung</h3>
            <p><strong>23 Sistem</strong></p>
        </div>
        <div class="dashboard-card">
            <h3><i class="fas fa-exclamation-triangle"></i> Error Terdeteksi</h3>
