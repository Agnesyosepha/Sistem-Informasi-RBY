...
Route::put('/superadmin/admin/superadmin-proposal/update-status/{id}', [App\Http\Controllers\AdminController::class, 'updateStatus'])->name('superadmin.admin.proposal.updateStatus');
...
Route::get('/superadmin/admin/superadmin-adendum/{id}/edit', [App\Http\Controllers\AdminController::class, 'editAdendum'])->name('superadmin.admin.SAadendum.edit');
Route::put('/superadmin/admin/superadmin-adendum/{id}', [App\Http\Controllers\AdminController::class, 'updateAdendum'])->name('superadmin.admin.SAadendum.update');
